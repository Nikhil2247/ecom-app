...
const Cart = () => {
  ...
  const calculateTotalPrice = () => {
    return cart.reduce((total, item) => {
      ...
      const price = matchedVariant ? matchedVariant.price : item.price;
  ...
  try {
    ...
    const orderData = {
      ...
      items: cart.map((item) => ({
        ...
        price: item.price || item.variant?.price, // Send price, fallback to variant price
                ...
                >
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-green-600 text-lg font-bold">
                      ₹{matchedVariant?.price || item.price} {/* Show the correct price */}
                    </p>
