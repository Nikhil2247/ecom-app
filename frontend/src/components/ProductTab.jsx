...
const ProductCard = ({ product, openQuickView }) => {
  ...
  return (
    <div className=" dark:bg-gray-900 relative group overflow-hidden">
      ...
      <div className="p-4">
        <h2 className="text-lg instrument-sans">{product.name}</h2>
        <div className="flex gap-2">
          <span className="text-md mt-1">${product.variants[0]?.price}</span>
      ...
      <div className="absolute bottom-28 left-0 right-0 py-4 px-16 bg-transparent bg-opacity-75 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button
