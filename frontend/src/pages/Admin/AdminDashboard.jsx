        ...
        <div className="mb-8">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg  border-2 border-gray-200">
              <h4 className="text-lg instrument-sans mb-2">Number of Users</h4>
              <p>{userCount}</p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg  border-2 border-gray-200">
              <h4 className="text-lg instrument-sans mb-2">Total Products</h4>
              <p>{productCount}</p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg  border-2 border-gray-200">
              <h4 className="text-lg instrument-sans mb-2">Total Categories</h4>
              <p>{categoryCount}</p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg  border-2 border-gray-200">
              <h4 className="text-lg instrument-sans mb-2">Total Orders</h4>
              <p>{orderCount}</p>
            </div>
          </div>
        </div>
